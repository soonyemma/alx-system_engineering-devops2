...
This project involves learning how web servers work and began using one. I was
provided a personal server by ALX, used `scp`
and Fabric to transfer files to server and completed a basic
